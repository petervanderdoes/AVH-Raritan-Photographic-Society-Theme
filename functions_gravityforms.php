...
{
    $_fields['first_name'] = array(
        'gf_index' => '1.3',
        'wp_meta' => 'first_name'
    );
    $_fields['last_name'] = array(
        'gf_index' => '1.6',
        'wp_meta' => 'last_name'
    );
    $_fields['nickname'] = array(
        'gf_index' => '2',
        'wp_meta' => 'nickname'
    );
    $_fields['display_name'] = array(
        'gf_index' => '3',
        'wp_meta' => 'display_name'
    );
    $_fields['website'] = array(
        'gf_index' => '8',
        'wp_meta' => 'user_url'
    );
    
    // Fields below are added by the parent Theme.
    $_fields['facebook'] = array(
        'gf_index' => '9',
        'wp_meta' => 'facebook'
    );
    $_fields['flickr'] = array(
        'gf_index' => '10',
        'wp_meta' => 'flickr'
    );
    ...
    foreach ($form['fields'] as &$field) {
        ...
        if (strpos($field['cssClass'], 'rps-profile-display-name') !== false) {
            ...
            if (! in_array($_profileuser->display_name, $_public_display)) // Only add this if it isn't duplicated elsewhere
                $_public_display = array(
                    'display_displayname' => $_profileuser->display_name
                ) + $_public_display;
