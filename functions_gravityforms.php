 ...
 * This field exists in the contact form and is used as a conditional field.
 * If that field has the value as given in this function, we're able to disable other field.
 *
 * @uses $user_ID
 *
 * @param string $value
