...
<?php
    ...
    if ('open' == $post->comment_status) {
        ...
        rps_comment_form(apply_filters('suffusion_comment_form_fields', array(
            'fields' => array(
                'author' => $author_field,
                'email' => $email_field,
                'url' => $url_field
            ...
            'logged_in_as' => '',
            'must_log_in' => '<p class="must-log-in">' . '<a href="' . wp_login_url(apply_filters('the_permalink', get_permalink($post->ID))) . '">' . __('You must be logged in to post a comment.', 'suffusion') . '</a></p>',
