    ...
    if (post_password_required()) {
        ...
        if (have_comments()) {
            ...
            <h3 class="comments">
                ...
                <?php printf(
                    __('%1$s to &#8220;%2$s&#8221;', "suffusion"),
                    comments_number(
                        __('No Responses', "suffusion"),
                        __('One Response', "suffusion"),
                        __('% Responses', "suffusion")
                    ),
        ...
        if ('open' == $post->comment_status) {
                    ...
                    <p>
                        ...
                        <input type='text' name='author' id='author' class='textarea inside'
                            onblur='if (this.value == \"\") {this.value = \"" .
                                esc_attr($suf_comment_label_name . " " . $author_req) .
                                "\";}'
                ...
                $email_field = "
                    <p>
                        ...
                        <input type='text' name='email' id='email' class='textarea inside'
                            onblur='if (this.value == \"\") {this.value = \"" .
                               esc_attr($suf_comment_label_email . " " . $email_req) .
                               "\";}'
                            onfocus='if (this.value == \"" .
                               esc_attr($suf_comment_label_email . " " . $email_req) .
                               "\") { this.value = \"\"; }'
                ...
                $comment_field = "
                    <p>
                        ...
                        <textarea name='comment' id='comment' cols='60' rows='10' tabindex='4' class='textarea inside'
                            onblur='if (this.value == \"\"){this.value = \"" .
                                 esc_attr($suf_comment_label_your_comment) .
                                 "\";}'
                            onfocus='if (this.value == \"" .
                                 esc_attr($suf_comment_label_your_comment) .
                                 "\"){this.value = \"\";}'>" .
                ...
                $author_field = "
                    <p>
                        ...
                        <input type='text' name='author' id='author' class='textarea' value='" .
                                ...
                                "' size='28' tabindex='1' /> " .
                                ($req ? $suf_comment_label_name_req : "") .
                                "
                    </p>";
                $email_field = "
                    <p>
                        ...
                        <input type='text' name='email' id='email' value='" .
                               ...
                               ($req ? $suf_comment_label_email_req : "") .
                               "
                    </p>";
                $url_field = "
                    <p>
            ...
            rps_comment_form(
                apply_filters(
                    ...
                    [
                        ...
                        'logged_in_as'         => '',
                        'must_log_in'          => '<p class="must-log-in">' . '<a href="' . wp_login_url(
                                apply_filters(
                                    'the_permalink',
                        ...
                        'comment_notes_after'  => apply_filters(
                            'suffusion_after_comment_form',
            ...
            if (is_page() && isset($suf_comments_disabled_all_sel) && $suf_comments_disabled_all_sel == 'all') {
                ...
                if (is_page() &&
                    isset($suf_comments_disabled_all_sel) &&
                    $suf_comments_disabled_all_sel != 'all' &&
                    isset($suf_comments_disabled)
                ) {
                    $disabled_pages = explode(',', $suf_comments_disabled);
                    if (is_array($disabled_pages) &&
                        count($disabled_pages) > 0 &&
