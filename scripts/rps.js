(function ($, window) {
  ...
  $(function () {
     ...
     */
    var Links = '.entry a[href^="http://"]' +
      ', #comments a[href^="http://"]' +
      ', .entry a[href^="https://"]' +
      ', #comments a[href^="https://"]';
    $(Links)
    ...
    var RpsImages = '.rps-showcases a[href*=".jpg"]' +
      ', .entry a[href*=".jpg"]' +
      ', .entry area[href*=".jpg"]' +
      ', .entry a[href*=".gif"]' +
      ', .entry area[href*=".gif"]' +
    ...
    var RpsDownloads = '.entry a[href*=".pdf"]';
    $(RpsDownloads)
      .each(function () {
        $(this)
          .attr({
...
(eventCategory, eventAction, eventLabel) {
  return '__gaTracker(\'send\',\'event\', \'' +
    eventCategory +
    '\', \'' +
    decodeURIComponent(eventAction) +
    '\', \'' +
    decodeURIComponent(eventLabel) +
    '\';, {\'nonInteraction\': 1}';
}
