...
<div class="login" id="theme-my-login<?php $template->the_instance(); ?>">
	...
	<p>Besides registration you also need to be a paying member to make full usage of the site. If you are not paid up you will not be able to see the Members sections of this site and will not be allowed to enter the competitions.</p>
